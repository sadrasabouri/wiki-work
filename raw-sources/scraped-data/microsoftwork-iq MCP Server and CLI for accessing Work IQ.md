---
title: "microsoft/work-iq: MCP Server and CLI for accessing Work IQ"
source: "https://github.com/microsoft/work-iq"
author:
published:
created: 2026-05-16
description: "MCP Server and CLI for accessing Work IQ. Contribute to microsoft/work-iq development by creating an account on GitHub."
tags:
  - "clippings"
---
...
**For Tenant Administrators:** See the [Tenant Administrator Enablement Guide](https://github.com/microsoft/work-iq/blob/main/ADMIN-INSTRUCTIONS.md) for detailed instructions on granting admin consent, including a quick one-click consent URL.
...
| Plugin | Description |
| --- | --- |
| [**workiq**](https://github.com/microsoft/work-iq/blob/main/plugins/workiq) | Query Microsoft 365 data with natural language — emails, meetings, documents, Teams messages, and more. |
| [**microsoft-365-agents-toolkit**](https://github.com/microsoft/work-iq/blob/main/plugins/microsoft-365-agents-toolkit) | Toolkit for building and evaluating M365 Copilot declarative agents — scaffolding, manifest authoring, capability configuration, and eval workflows. |
| [**workiq-productivity**](https://github.com/microsoft/work-iq/blob/main/plugins/workiq-productivity) | Read-only WorkIQ productivity insights — email triage, meeting costs, org charts, channel audits, and more. |

> 📖 **See [PLUGINS.md](https://github.com/microsoft/work-iq/blob/main/PLUGINS.md)** for the full plugin catalog with detailed skill listings, example prompts, MCP server info, and installation instructions.
...
We welcome new plugins! See [CONTRIBUTING.md](https://github.com/microsoft/work-iq/blob/main/CONTRIBUTING.md) for the full guide. In short:
...
By using this package, you accept the license agreement. See [NOTICES.TXT](https://github.com/microsoft/work-iq/blob/main/NOTICES.TXT) and EULA within the package for legal terms.
