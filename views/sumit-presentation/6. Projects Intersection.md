...
| Idea | In Pista | In Wiki KB | Why this is the same idea | Provenance |
| ---- | -------- | ---------- | ------------------------- | ---------- |
| **Views as the central abstraction** | DAG view, step-by-step reveal, formula-only view of agent execution | Design doc, timeline, contribution map, presentation, `wiki/index.md` itself | Both render computation differently for different audiences; both are templates with prompt-filled holes ([[views]]) | [[raw-sources/meeting-transcripts/T4-2026-03-16-2006]] · Sumit |
| **DAG of Computation** | Per-cell dependency graph; "see" of stop/see/steer | Full-system provenance DAG (raw → wiki entities → views); "wiki is just another node" | Same graph at different scales — Pista's DAG is a subgraph of the KB DAG ([[dag-of-computation]]) | [[raw-sources/meeting-transcripts/T12-2026-05-04-2]] · Sumit |
| **Participation over post-hoc review** | Trust accumulates *during* interaction, not from output quality (N=16 study) | PR model for KB updates; "AI slop vs. AI beauty"; humans steer what the KB accumulates | Sumit's failed "connect" generation in [[T13-2026-05-05-1]] and Souti's slop-recovery move are the same finding from different angles ([[steerability]]) | [[raw-sources/research-papers/Auditing and Controlling AI Agent Actions in Spreadsheets]] · Sadra |
| **Steerability at step boundaries** | F4/F5 — localized edit and branching at each computation step | Each prompt-hole in a view is a steer point; vibe session is steerability for view authoring | "Steerability is most meaningful at workflow step boundaries" — applies whether the workflow is a spreadsheet computation or a view-authoring session ([[steerability]]) | [[raw-sources/meeting-transcripts/T4-2026-03-16-2006]] · Sumit |
| **Semantic diff** | Surface the formula, not 500 highlighted cells | Surface the prompt + raw source that produced a section, not just rendered text | Both surface computational *intent* over artifact surface; the principle is explicitly stated as domain-agnostic in the Pista paper ([[semantic-diff]]) | [[raw-sources/research-papers/Auditing and Controlling AI Agent Actions in Spreadsheets]] · Sadra |
| **Gulf of Envisioning** | F7 — persistent scaffolding questions at every step | Vibe sessions; FlashFill convergence for view authoring | Same diagnosis: users don't know what the system can do; static onboarding insufficient; need scaffolding at every interaction point ([[gulf-of-envisioning]]) | [[raw-sources/meeting-transcripts/T4-2026-03-16-2006]] · Sumit, Souti |
| **Provenance as first-class** | Each cell traceable to the formula step that produced it | Each claim traceable to a raw-sources file; AI-generated content flagged | Same trust mechanism: artifacts are only legible if their lineage is inspectable ([[provenance-tracking]]) | [[raw-sources/meeting-transcripts/T9-2026-05-02-2]] · Sadra |
| **Workflows / Skills as creative artifacts** | The agent's underlying methodology is a first-class object | Per-prompt skills are a community gallery, not implementation details | Both projects treat HOW as worth capturing, not just WHAT ([[skills]], [[workflows]]) | [[raw-sources/meeting-transcripts/T14-2026-05-05-2]] · Sumit |
| **Self-referential application** | Pista verifies AI-written spreadsheets analysts use | KB writes its own paper from transcripts of designing the KB | Both projects use their own output as a stress test ([[self-referential-kb]]) | [[raw-sources/emails/Presentation]] · Sadra |
