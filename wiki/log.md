...
- Views regenerated: views/brainstorm-2026-05-13.md (updated 2026-05-16: new IQ stack provocations, typed edges hypothesis, wiki-as-MCP implication, one-big-bet reframe)
...
- Open issues: see clarification questions below

## [2026-05-03] ingest | Initial build from all raw sources

Sources ingested (13 files):

**Emails:**
- [[Thursday demo]] — views structure, semi-private mashing, simulation metaphor, KB-as-codebase analogy, self-referential presentation idea
- [[Presentation]] — presentation-as-view concept, sub-views as slide titles
- [[misc thoughts]] — self-referential KB, agent self-organization / "consciousness" observation
