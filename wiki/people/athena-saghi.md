...
Produced the [[productivity-creativity-tradeoff|Productivity-Creativity Tradeoff]] finding: LLMs increase productivity but reduce the frequency of "aha moments" and time spent on idea generation. Used the Wallace creativity model (preparation → incubation → illumination → verification) and Torrance creativity tests as theoretical frameworks.
